...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var authToken, url, response, content, chunk, hex, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    authToken = process.env.LOG_AUTH_TOKEN;
                    if (!authToken) {
                        console.error("LOG_AUTH_TOKEN not set");
                        process.exit(1);
                    }
                    url = "https://moc.elcanotek.com/logs/db30f519-3c37-4603-87e6-e8b7b9950d02";
                ...
                case 2:
                    content = _a.sent();
                    console.log("Got ".concat(content.length, " characters"));
                    ...
                    console.log("\n\nHEX:");
                    hex = "";
                    for (i = 0; i < Math.min(200, chunk.length); i++) {
